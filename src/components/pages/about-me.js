      ...
      <div className="right-column">
        <div className="contact-bullet-points">
          ...
          >
            ...
            >
              I think setting up the paths and pieces to reach big moments for an individual player is what enchants me the most about my favorite video games; that perfect marriage of the player's story and gameplay. I love games that guide the player through fun pacing, well-intentioned dialogue, and/or connected gameplay elements leading to true moments of mastery, marvel, or mystique.
              <br /><br />
